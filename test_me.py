...
with open('test_me_out.txt', 'w') as f:
    with serial.Serial('COM3', 77700) as ser: #open serial port
            ...
            while (True):
                if not initialized:
                    ...
                    for i in range(32):
                        ...
                        ser.write(writestartfreq(15 + (1/19) * i,i))
                        ser.write(writestopfreq(15 + (1/19) * i,i))
                    ...
                    for i in range(4):
                        ...
                        ser.write(writeloadphase(0, (5*i)+1))
                        ser.write(writeloadphase(0, (5*i)+2))
                        ser.write(writeloadphase(0, (5*i)+3))
                        ser.write(writeloadphase(0, (5*i)+4))
