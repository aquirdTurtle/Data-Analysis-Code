...
def organizeTransferData(fileNumber, atomLocs1, atomLocs2, arbAtomLocs = None, key=None, window=None, xMin=None, xMax=None, yMin=None,
    ...
    if arbAtomLocs is not None:
        atomLocs1 = arbAtomLocs
        atomLocs2 = arbAtomLocs
